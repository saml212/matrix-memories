...
def fig1_razor_step(repo, out_dir):
    """Evidence N1/N2/N3: per-group thresholded-recovery step at k = d_min.
    ...
    fig.supylabel("thresholded recovery, crosscheck rec@0.9 (fraction)", fontsize=8)
