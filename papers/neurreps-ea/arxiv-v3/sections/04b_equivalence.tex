...
siems2025deltaproduct}. This matched-dimension comparison tests whether
measured effective rank is equivalent across the selected pair despite
their opposite solvability. \citet{siems2025deltaproduct} provide the
...
Figure~\ref{fig:tracking} (lower panel). These results establish
equivalence of effective rank for this matched-dimension pair within the
pre-registered $\pm 0.5$ rank-unit tolerance.
